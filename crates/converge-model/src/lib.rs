...
pub use self::wire::{
    ...
    CreateLaneRequest, EventRecord, GateGraph, GateNode, InboxBundle, InboxLane, InboxPublication,
    InboxReport, LaneHead, LaneRecord, NegotiateRequest, NegotiateResponse, ObjectFrame, ObjectSet,
