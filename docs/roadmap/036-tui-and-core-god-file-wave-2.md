...
- Started `cmd_remote_actions.rs` decomposition by extracting argument parsing for pin/approve/promote/release/superpositions into `src/tui_shell/app/remote_action_parse.rs`.
