...
- [Translation Memo 001: Snap Semantics](../research/translation-memos/001-snap-semantics.md)
- [Track 1: Continuous Capture vs. Explicit Commit](../research/value-tracks/continuous-capture-vs-explicit-commit.md)
