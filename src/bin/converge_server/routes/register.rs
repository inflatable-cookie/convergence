...
pub(super) fn register_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    register_identity_routes(router)
        .pipe(register_membership_routes)
        .pipe(register_repo_core_routes)
        .pipe(register_release_promotion_routes)
        .pipe(register_object_routes)
        .route("/repos/:repo_id/gc", axum::routing::post(gc_repo))
}

fn register_identity_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
...
fn register_membership_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
        .route(
...
fn register_repo_core_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
...
fn register_release_promotion_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
        .route(
...
fn register_object_routes(router: Router<Arc<AppState>>) -> Router<Arc<AppState>> {
    router
        .route(
